...
export const getGetVehicleQueryOptions = <TData = Awaited<ReturnType<typeof getVehicle>>, TError = unknown>(id: number, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getVehicle>>, TError, TData>>, }
) => {
...
export const getUpdateVehicleMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateVehicle>>, TError,{id: number;data: PartialVehicleInput}, TContext>, }
): UseMutationOptions<Awaited<ReturnType<typeof updateVehicle>>, TError,{id: number;data: PartialVehicleInput}, TContext> => {
...
const {mutation: mutationOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateVehicle>>, {id: number;data: PartialVehicleInput}> = (props) => {
          const {id,data} = props ?? {};
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TError,
        {id: number;data: PartialVehicleInput},
        TContext
      > => {
